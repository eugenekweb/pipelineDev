...
- Общая продолжительность: 25 недель
...
|------|-------------------|-------------------|
| Сбор и анализ требований | 3 недели | - Спецификация требований<br>- Use-case диаграммы<br>- Техническое задание |
| Проектирование | 3 недели | - Схема архитектуры<br>- Дизайн-макеты<br>- Схема базы данных |
| Реализация | 6 недель | - Исходный код<br>- База данных<br>- Техническая документация |
| Тестирование | 3 недели | - Тест-кейсы<br>- Отчеты о тестировании<br>- Список исправлений |
| Внедрение | 1 неделя | - Установочный пакет<br>- Руководство пользователя |
...
gantt
    ...
    Согласование и утверждение  :a2, after a1, 3d
    ...
    Техническая документация  :b3, after b2, 1w
    Утверждение дизайна и архитектуры, Guide Style    :milestone, m2, after b3, 0d

    section Реализация
    Разработка ядра системы    :c1, after m2, 3w
    Разработка интерфейса  :c2, after c1, 12d
    Интеграция и оптимизация  :c3, after c2, 12d
    Завершение реализации    :milestone, m3, after c3, 0d
    ...
    Завершение тестирования    :milestone, m4, after d3, 0d

    section Внедрение
    Подготовка к релизу    :e1, after m4, 3d
    Развертывание  :e2, after e1, 3d
    Поддержка  :e3, after e2, 4d
    Готовность к релизу    :milestone, m5, after e3, 0d
